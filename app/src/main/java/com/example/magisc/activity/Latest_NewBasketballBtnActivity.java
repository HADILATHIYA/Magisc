...
public class Latest_NewBasketballBtnActivity extends Activity {
    /* access modifiers changed from: protected */
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.latest_new_activity_basketball);
    ...
    public void JumpShot(View view) {
        next_activity("Jump Shot");
    }

    public void HookShot(View view) {
        next_activity("Hook Shot");
    }

    public void BankShot(View view) {
        next_activity("Bank Shot");
    }

    public void FreeThrow(View view) {
        next_activity("Free Throw");
    }

    public void Layup(View view) {
        next_activity("Layup");
    }

    public void SlamDunk(View view) {
        next_activity("Slam Dunk");
    }
